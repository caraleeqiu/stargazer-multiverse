    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-12 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="px-8 py-4 bg-white/5 border border-white/20 text-white rounded-full font-medium text-lg hover:bg-white/10 transition-all flex items-center gap-2">
      ...
      <div className="relative z-10 mt-16 w-full max-w-5xl mx-auto">
        <div className="aspect-video rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-violet-900/30 to-pink-900/30 shadow-2xl shadow-violet-500/10">
          ...
          <div className="w-full h-full flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white/40">Hero Video Placeholder</p>
            </div>
          </div>
        </div>
      </div>
